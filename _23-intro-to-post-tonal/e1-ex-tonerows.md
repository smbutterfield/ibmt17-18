...
As with most things, some enterprising people have created a shortcut to all of this work. There are now free-to-use matrix calculators such as [this excellent website](https://www.musictheory.net/calculators/matrix). These are great to speed up your analysis, but as a student, make sure that you understand the principles of why and how these work before becoming entirely reliant on them. 

Admittedly, it is unlikely that you will ever be required to create a tone row matrix by hand without access unless you are taking a music theory exam. But the tedium of transposing each of the rows by hand will help you notice patterns in the tone row and help you to remember the nuances of the tone row as you analyze. This often provides insight into the analysis that would be missed by those relying on a calculator to create the matrix.